...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            ...
            <hr>
            <form action="{{route('userUbahSave',$pengguna)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="ic">No. Kad Pengenalan</label>
                    <input type="text" name="ic" id="ic" class="form-control @error('ic') is-invalid @enderror" value="{{$pengguna->ic}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{$pengguna->nama}}">
